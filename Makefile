...
rinha: $(SOURCES_C)
	$(CC) $(CFLAGS) $(SOURCES_C) -o $@ -ljansson -lllhttp -luuid -lpq -lpgport -lpgport_shlib -lpgcommon -lpgcommon_shlib -I$(INCLUDEDIR) -L$(LIBDIR)
