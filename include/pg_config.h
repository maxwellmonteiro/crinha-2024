...
#define CONFIGURE_ARGS " '--disable-shared' '--enable-static' '--prefix=/' '--bindir=${prefix}/bin' '--sbindir=${prefix}/bin' '--libdir=${prefix}/lib' '--includedir=${prefix}/include' '--oldincludedir=${prefix}/include' '--without-readline' '--without-zlib' '--without-openssl' 'CFLAGS= -m64 -fPIC -O3' 'LDFLAGS= -m64' 'LIBS=' 'CPPFLAGS= -DNDEBUG' 'CXXFLAGS= -m64 -fPIC -O3' 'PKG_CONFIG_PATH=/home/conan/w/prod-v2/BuildSingleReference/p/b/libpqccdf0989514f1/b/build-release/conan/../../build-release/conan:'"
...
#define PG_VERSION_STR "PostgreSQL 15.4 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 11.1.0, 64-bit"
